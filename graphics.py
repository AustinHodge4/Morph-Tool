...
class Application():
    ...
    def build_window(self):
        def open_file(event):
            ...
            entry.delete(0, "end")
            # Open dialog box to select ppm file
        ...
        def morph(root, first_image_entry, second_image_entry, steps_entry, max_steps=100):
            ...
            try:
                ...
                if number_of_steps > max_steps:
                    messagebox.showerror(title='Hold up', message='The max Number of Steps is 100!')
        ...
        first_image_label = Label(self.window, text="First Image", bg='red', anchor='w')
        ...
        # First image label and input field
        second_image_label = Label(self.window, text="Second Image", bg='red', anchor='w')
        ...
        steps_label = Label(self.window, text="Number of Images (Inclusive)", bg='red', anchor='w')
        steps_label.place(x = 20, y = 96, width=126, height=25)
